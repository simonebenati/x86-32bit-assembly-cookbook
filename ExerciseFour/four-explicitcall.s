...
.section .text
    ...
    _start:
        pushl $5        #this factorial takes one argument - the number we want a factorial of.
                        # so it gets pushed to the stack
        pushl $return_mem_address
        jmp factorial  #call factorial piece of code (function)
    return_mem_address:
